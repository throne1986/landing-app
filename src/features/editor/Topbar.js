  ...
  return (
    ...
    <div className="row">
                <div className="col-9 widget-header">
                    <span onClick={() => history.push('/')} className="widget-logo float-start">
                        <img src={widgetLogo} alt="widget logo" />
                    </span>
                </div>
                <div className="col-3 widget-options">
                     <div className="widget-options_undo"
                        size="small"
                        variant="outlined"
                        color="secondary"
                        disabled={!canUndo}
                     ...
                     <div className="widget-options_redo"
                        size="small"
                        variant="outlined"
                        color="secondary"
                        disabled={!canRedo}
                     ...
                     <button className="btn btn-danger widget-save">SAVE</button>
                        ...
                        <div onClick={onClick} className="menu-trigger">
                            {isActive?<i className="fas fa-angle-down"></i>: <i className="fas fa-angle-up"></i>}
                        </div>
                        <nav ref={dropdownRef} className={`menu ${isActive ? "active" : "inactive"}`}>
                            <ul className="navbar-nav">
                                <li className="nav-item"> <i className="fas fa-cogs"></i> Change Domain and Position</li>
                            </ul>
                        </nav>
                </div>
            </div>
