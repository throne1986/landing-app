...
import { inputChange } from '../reducers/WidgetSlice';
        ...
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div className="accordion-body">
                     <label htmlFor="basic-url" className="form-label">Add your website url and press enter</label>
                    <div className="input-group mb-3">
                      ...
                      <div className="btn-group my-3 d-flex justify-content-center align-items-center">
                          ...
                          <button value={widget.position} name="position" type="button" className={`btn btn-sm mx-2  ${position === "Bottom Center" ? "btn-info text-white" : "btn-lightDark"}`} onClick={(e) => {setPosition(position !== "Bottom Center" ? "Bottom Center" : ""); handlePosition(e);}}>Bottom Center</button>
          ...
          <div className="accordion-item">
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div className="accordion-body">
              <label htmlFor="basic-url" className="form-label">Choose a movie to add interactive elements</label>
                 <div className="widget-add-block"
                      ref={(ref) =>
          ...
          <div className="accordion-item">
            ...
            <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div className="accordion-body">
              <label htmlFor="basic-url" className="form-label">Click Pallete to Change the color</label>
               {/* <Picker /> */}
          ...
          <div className="accordion-item">
            ...
            <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div className="accordion-body">
              <label htmlFor="basic-url" className="form-label">Drag and drop to add the button</label>
